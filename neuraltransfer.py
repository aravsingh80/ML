...
def stylize(cuda, content_image, content_scale, style_num, model, style_id):
    ...
    utils.save_image('output/'+args.output_image+'_style'+str(style_id)+'.jpg', output[0])
...
def main():
    ...
    train_arg_parser.add_argument("--style-image", type=str, default="images/content_images/",
